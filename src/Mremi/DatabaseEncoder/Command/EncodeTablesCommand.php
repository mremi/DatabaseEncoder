...
/**
 * Encodes all string columns by the given tables
 *
 * @author Rémi Marseille <marseille.remi@gmail.com>
 */
class EncodeTablesCommand extends Command
{
    /**
     * {@inheritdoc}
     */
    protected function configure()
    {
        ...
        $this
            ->setName('encode-tables')
            ->setDescription('Encodes all string columns by the given tables')
            ...
            ->addArgument('tables',   InputArgument::REQUIRED, 'An array of tables/columns to convert')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $handler->encodeTables(json_decode($input->getArgument('tables'), true), $input->getOption('encoding'), $input->getOption('dry-run'));
    }
}
